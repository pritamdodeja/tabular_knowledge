...
# pima_data.head()
# # }}}
# {{{ df_metadata function
# start out with assuming all features are numerical
# remove the ones that have object type from that list
# from the remaining numerical, remove the ones that have less than threshold
# different values they take on
